      ...
      <section className="mx-auto max-w-7xl px-5 py-20">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {product.specs.map((s) => (
            <div
              key={s.label}
              className="glass-panel rounded-3xl p-6 transition-transform duration-500 hover:-translate-y-2"
            >
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {product.gallery.map((g) => (
            <div key={g} className="glass-panel relative overflow-hidden rounded-3xl p-3">
              <img
                src={g}
          ...
          {products
            ...
            .map((p) => (
              <Link
                ...
                to="/products/$slug"
                params={{ slug: p.slug }}
                className="glass-panel group overflow-hidden rounded-3xl p-3 transition-transform duration-500 hover:-translate-y-2"
              >
                <img
                  src={p.image}
                  alt={p.name}
